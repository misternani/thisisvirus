...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Add Image Quiz</a></li>
      </ul>
          </div>
  </div>
</nav>
...
if (@$_GET['q'] == 0) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz ORDER BY status ASC") or die('Error');
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="category" name="category" placeholder="Enter category" class="form-control input-md"  type="text">
...
//image quiz part start
if (@$_GET['q'] == 4 && (@$_GET['step']) == 28) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update.php?q=addimgqns&n=' . @$_GET['n'] . '&eid=' . @$_GET['eid'] . '&ch=4 "  method="POST" enctype="multipart/form-data">
<fieldset>
';
...
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Quiz Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addimagequiz"  method="POST">
<fieldset>
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Image Quiz title" class="form-control input-md" type="text">
